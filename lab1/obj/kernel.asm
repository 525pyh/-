...
void interrupt_handler(struct trapframe *tf) {
    ...
    802003d0:	bb470713          	addi	a4,a4,-1100 # 80200f80 <etext+0x55c>
...
void interrupt_handler(struct trapframe *tf) {
    ...
    80200430:	b3450513          	addi	a0,a0,-1228 # 80200f60 <etext+0x53c>
    ...
    80200440:	afc50513          	addi	a0,a0,-1284 # 80200f38 <etext+0x514>
...
void exception_handler(struct trapframe *tf) {
    ...
    80200488:	02e79563          	bne	a5,a4,802004b2 <exception_handler+0x42>
    ...
    80200490:	b2450513          	addi	a0,a0,-1244 # 80200fb0 <etext+0x58c>
    ...
    802004a0:	b3c50513          	addi	a0,a0,-1220 # 80200fd8 <etext+0x5b4>
    ...
    802004ce:	b3e50513          	addi	a0,a0,-1218 # 80201008 <etext+0x5e4>
    802004d2:	b99ff0ef          	jal	ra,8020006a <cprintf>
		    cprintf("ebreak caught at 0x%016llx\n", tf->epc);
    802004d6:	10843583          	ld	a1,264(s0)
    802004da:	00001517          	auipc	a0,0x1
    802004de:	b4e50513          	addi	a0,a0,-1202 # 80201028 <etext+0x604>
...
00000000802004f8 <trap>:

/* trap_dispatch - dispatch based on what type of trap occurred */
static inline void trap_dispatch(struct trapframe *tf) {
    if ((intptr_t)tf->cause < 0) {
    802004f8:	11853783          	ld	a5,280(a0)
    802004fc:	0007c363          	bltz	a5,80200502 <trap+0xa>
        // interrupts
        interrupt_handler(tf);
    } else {
        // exceptions
        exception_handler(tf);
    80200500:	bf85                	j	80200470 <exception_handler>
        interrupt_handler(tf);
    80200502:	bd75                	j	802003be <interrupt_handler>
...
__alltraps:
    ...
    jal trap
    80200568:	f91ff0ef          	jal	ra,802004f8 <trap>
...
printnum(void (*putch)(int, void*), void *putdat,
    ...
    802005f8:	a5478793          	addi	a5,a5,-1452 # 80201048 <etext+0x624>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
    ...
    80200654:	a2ca8a93          	addi	s5,s5,-1492 # 8020107c <etext+0x658>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
    ...
    8020065c:	c00b8b93          	addi	s7,s7,-1024 # 80201258 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
    ...
    802008b2:	7ca60613          	addi	a2,a2,1994 # 80201078 <etext+0x654>
    ...
    802008c4:	7a860613          	addi	a2,a2,1960 # 80201068 <etext+0x644>
    ...
    802008d6:	78e40413          	addi	s0,s0,1934 # 80201060 <etext+0x63c>
    ...
    80200960:	70440413          	addi	s0,s0,1796 # 80201060 <etext+0x63c>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
    ...
    80200976:	6efa0a13          	addi	s4,s4,1775 # 80201061 <etext+0x63d>
